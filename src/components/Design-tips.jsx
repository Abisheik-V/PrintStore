  ...
  return (
    <div className="pod-app bg-light text-dark min-vh-100 d-flex flex-column">
      ...
      <main className="flex-grow-1">
        <section className="pod-section" id="design-tips-page">
          <div className="container py-5 py-md-6">
            <div className="text-center mb-5" data-aos="fade-up">
              <h1 className="pod-section-title mb-2">Design tips for better merch</h1>
              <p className="text-muted mb-0">
                Practical advice for creating artwork that prints well and connects with your audience.
              </p>
            </div>
            ...
            <div className="row g-4 mb-5" data-aos="fade-up" data-aos-delay="50">
              <div className="col-12 col-lg-6">
                <div className="pod-card h-100">
                  <h5 className="mb-3">Prepare print‑ready files</h5>
                  <ul className="pod-list text-muted mb-0">
                    <li>Use high‑resolution artwork (at least 300 DPI at print size).</li>
                    <li>Export to PNG with transparent background for apparel and layered designs.</li>
                    <li>Keep key elements away from edges to avoid trimming issues.</li>
                    <li>Check colors on both light and dark backgrounds before publishing.</li>
                  </ul>
                </div>
              </div>
              <div className="col-12 col-lg-6">
                <div className="pod-card h-100">
                  <h5 className="mb-3">Design for your audience</h5>
                  <ul className="pod-list text-muted mb-0">
                    <li>Start with 1–3 strong concepts that reflect your brand or community.</li>
                    <li>Use clear, legible typography at real‑world viewing sizes.</li>
                    <li>Avoid over‑crowding; leave breathing room around the main idea.</li>
                    <li>Test designs with a small group of fans before launching widely.</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="row g-4" data-aos="fade-up" data-aos-delay="100">
              <div className="col-12 col-lg-6">
                <div className="pod-card h-100">
                  <h5 className="mb-3">Choosing colors & placements</h5>
                  <ul className="pod-list text-muted mb-0">
                    <li>Use high‑contrast color combos for key text and icons.</li>
                    <li>Check how designs look on multiple garment colors or product variants.</li>
                    <li>Center chest prints for tees; keep designs within standard print areas.</li>
                    <li>For mugs and posters, preview both left/right and full‑wrap layouts.</li>
                  </ul>
                </div>
              </div>
              <div className="col-12 col-lg-6">
                <div className="pod-card h-100">
                  <h5 className="mb-3">Mockups & product pages</h5>
                  <ul className="pod-list text-muted mb-0">
                    <li>Use multiple mockups to show products from different angles.</li>
                    <li>Include close‑ups where details or textures are important.</li>
                    <li>Write descriptions that explain fit, materials, and use cases.</li>
                    <li>Group related designs into collections for easier browsing.</li>
                  </ul>
                </div>
              </div>
            </div>
